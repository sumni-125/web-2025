...
%>
	...
	<form name="frm" action="signup" method="post" enctype="multipart/form-data" class="form">
		<img class="joong"
			src="https://web.joongna.com/main-web/assets/images/custom-logo.svg"
			alt="중고나라 이미지">
		<h2>회원가입</h2>
		<label for="user_id">아이디</label>
<input type="text" id="user_id" name="user_id" placeholder="아이디 입력" required class="input-text">

<label for="password">비밀번호</label>
<input type="password" id="password" name="password" placeholder="비밀번호 입력" required class="input-password">

<label for="username">이름</label>
<input type="text" id="username" name="username" placeholder="이름 입력" required class="input-text">

<label for="email">이메일</label>
<input type="email" id="email" name="email" placeholder="이메일 입력" required class="input-email">

<label for="phone">전화번호</label>
<input type="tel" id="phone" name="phone" placeholder="- 없이 숫자만 입력" required class="input-tel">
