<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.ArrayList, java.util.List,Review.ReviewDTO, java.text.SimpleDateFormat"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
			...
			<div class="review-item">
				<div class="review-header">
					<div class="review-info">
						<span class="reviewer-id"><%=review.getReviewerId()%></span> <span
							class="review-date"><%=sdf.format(review.getReviewDate())%></span>
					</div>
					<div class="rating">
						<%
