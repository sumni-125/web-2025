			...
			<div class="form-container">
				...
				<form action="registerproduct" method="post"
					...
					<div class="form-group">
						<label for="title">상품 이름:</label> <input type="text" id="title"
						...
						<label for="category">카테고리:</label> <select id="category"
							...
							<c:forEach var="category" items="${categories}">
								<option value="${category.categoryId}"
									${category.categoryId eq selectedCategory ? 'selected' : ''}>${category.categoryName}</option>
							</c:forEach>
						</select>
					</div>
					...
					<div class="form-group">
						<label for="maxprice">입찰 희망가:</label> <input type="number"
							id="maxprice" name="maxprice" min="0" value="${maxprice}"
							required />
					</div>

					<div class="form-group">
						<label for="minprice">최소 입찰가:</label> <input type="number"
							id="minprice" name="minprice" min="0" value="${minprice}"
							required />
					</div>
					...
					<div class="form-group">
						...
						<div class="time-selection">
							...
							</select> <select id="auction_minutes" name="auction_minutes">
							...
							</select> <select id="auction_seconds" name="auction_seconds">
