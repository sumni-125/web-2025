...
.button-group .submit-button, .button-group .cancel-button {
	flex: 1;
	margin-top: 0;
}
 ...
 %> <span class="notification-badge"><%=unreadNotificationCount%></span>
	...
	<div class="review-container">
		<div class="product-info">
			<img
				src="${pageContext.request.contextPath}/<%= product.getImage_path() != null ? product.getImage_path() : "images/default.jpg" %>"
				alt="상품 이미지" class="product-image">
			<div class="product-details">
				<div class="product-title"><%=product.getTitle()%></div>
				<div class="seller-info">
					판매자:
					<%=product.getSeller_id()%></div>
				<div class="price-info"><%=product.getPrice()%>원
				</div>
			</div>
		</div>
		...
		<form action="submitreview" method="post">
			<input type="hidden" name="product_id"
				...
				name="seller_id" value="<%=product.getSeller_id()%>">
			...
			<div class="form-group">
				...
				<textarea id="description" name="description" required
					placeholder="이 상품과 판매자에 대한 솔직한 평가를 남겨주세요."></textarea>
			</div>
